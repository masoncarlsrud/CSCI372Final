...
def create_gui():
    ...
    root.configure(bg="white")  # Change background color to gray

    # General font
    general_font = ("Times New Roman", 14)

    # Title label
    title_label = tk.Label(root, text="Weather App", bg="white", font=("Times New Roman", 24, "bold"))
    ...
    location_label = tk.Label(input_frame, text="Enter Location:", bg="white", font=general_font)
